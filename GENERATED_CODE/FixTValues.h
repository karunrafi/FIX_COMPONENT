...
namespace FIX
{
 ...
 const char MsgType_MARKET_DATA_ACK[] = "UMDA";
 const char MsgType_SETUP_MONITOR_REQUEST[] = "USMQ";
 const char MsgType_UPDATE_MONITOR_PAGE_REQUEST[] = "UMPQ";
 const char MsgType_MONITOR_REQUEST_ACK[] = "USMQK";
