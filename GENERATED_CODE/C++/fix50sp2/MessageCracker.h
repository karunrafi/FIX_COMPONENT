...
public:
              ...
              const FIX::SessionID& sessionID )
  {
    ...
    if( msgTypeValue == "USMQ" )
      return onMessage( (const SetupMonitorRequest&)message, sessionID );
    
    if( msgTypeValue == "UMPQ" )
      return onMessage( (const UpdateMonitorPageRequest&)message, sessionID );
    
    if( msgTypeValue == "USMQK" )
      return onMessage( (const MonitorRequestAck&)message, sessionID );
    
    if( msgTypeValue == "UMDA" )
      return onMessage( (const MarketDataAck&)message, sessionID );
...
void crack( Message& message, 
            const FIX::SessionID& sessionID )
  {
    ...
    if( msgTypeValue == "USMQ" )
      return onMessage( (SetupMonitorRequest&)message, sessionID );
    
    if( msgTypeValue == "UMPQ" )
      return onMessage( (UpdateMonitorPageRequest&)message, sessionID );
    
    if( msgTypeValue == "USMQK" )
      return onMessage( (MonitorRequestAck&)message, sessionID );
    
    if( msgTypeValue == "UMDA" )
      return onMessage( (MarketDataAck&)message, sessionID );
