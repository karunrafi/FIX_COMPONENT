...
namespace FIX
{
  ...
  const int Product_PREFERRED = 100;
  ...
  const int BenchmarkPriceType_PERCENTAGE = 1;
  const int BenchmarkPriceType_PER_UNIT = 2;
  const int BenchmarkPriceType_FIXED_AMOUNT = 3;
  const int BenchmarkPriceType_SPREAD = 6;
  const int BenchmarkPriceType_YIELD = 9;
  const int BenchmarkPriceType_BASIS_POINTS = 22;
  ...
  const char BenchmarkSecurityIDSource_CUSIP[] = "1";
  const char BenchmarkSecurityIDSource_SEDOL[] = "2";
  const char BenchmarkSecurityIDSource_ISIN_NUMBER[] = "4";
  const char BenchmarkSecurityIDSource_ISO_CURRENCY_CODE[] = "6";
  const char BenchmarkSecurityIDSource_EXCHANGE_SYMBOL[] = "8";
  const char BenchmarkSecurityIDSource_BLOOMBERG_CUSTOM_IDENTIFIER_FOR_TBA_OUTRIGHT[] = "403";
  const char BenchmarkSecurityIDSource_BLOOMBERG_CUSTOM_IDENTIFIER_FOR_TBA_ROLL,SWITCH_OR_BUTTERFLY[] = "404";
  const char BenchmarkSecurityIDSource_BLOOMBERG_SYMBOL[] = "A";
  const char BenchmarkSecurityIDSource_WERTPAPIER[] = "B";
  const char BenchmarkSecurityIDSource_VALOREN[] = "D";
  const char BenchmarkSecurityIDSource_MARKETPLACE_ASSIGNED_IDENTIFIER[] = "M";
  ...
  const char InstrumentPartyID_ASIGNA_MEXICAN_CLEARING_EXCHANGE[] = "ASIGNA";
  const char InstrumentPartyID_AUSTRALIAN_STOCK_EXCHANGE[] = "ASX";
  const char InstrumentPartyID_SPANISH_CLEARING[] = "BME";
  const char InstrumentPartyID_CME_EUROPE[] = "CME EU";
  const char InstrumentPartyID_CME_US[] = "CME US";
  const char InstrumentPartyID_EUREX[] = "ERX GL";
  const char InstrumentPartyID_HONG_KONG_EXCHANGE[] = "HKEX";
  const char InstrumentPartyID_ICE_EUROPE[] = "ICE EU";
  const char InstrumentPartyID_ICE_US[] = "ICE US";
  const char InstrumentPartyID_JAPANESE_SECURITY_CLEARING_CORP[] = "JSCC";
  const char InstrumentPartyID_POLISH_CLEARING_EXCHANGE[] = "KDPW";
  const char InstrumentPartyID_LCH_EUROPE[] = "LCH EU";
  const char InstrumentPartyID_NASDAQ_US[] = "NASDAQ";
  const char InstrumentPartyID_SINGAPORE_EXCHANGE[] = "SGX";
  ...
  const int InstrumentPartyRole_CLEARING_ORGANIZATION = 21;
  ...
  const int MDQuoteType_BROKER_FIRM = 101;
  const int MDQuoteType_BROKER_NEEDS_APPROVAL = 102;
  const int MDQuoteType_BROKER_NEEDS_MULTILEVEL_APPROVAL = 103;
  ...
  const int MonitorRequestStatus_ACCEPTED = 0;
  const int MonitorRequestStatus_REJECTED = 1;
  const int RowSpanAttribute_NORMAL = 0;
  const int RowSpanAttribute_BLINK = 1;
  const int RowSpanAttribute_UNDERLINE = 2;
  const int RowSpanAttribute_REVERSE = 3;
  const int RowSpanAttribute_DOUBLEWIDTH = 4;
  const int RowSpanAttribute_POINTANDCLICK = 5;
  const int RowSpanAttribute_INTENSITY = 6;
  const int RowSpanAttribute_DOUBLEWIDTH_UNDERLINE = 7;
  const int RowSpanAttribute_DOUBLEWIDTH_REVERSE = 8;
  const int RowSpanAttribute_BLINK_FOREGROUND = 9;
  const int MDPriceVolumeLevel_LEVEL_ZERO = 0;
  const int MDPriceVolumeLevel_LEVEL_ONE = 1;
  const int MDPriceVolumeLevel_LEVEL_TWO = 2;
  const int MDPriceVolumeLevel_LEVEL_THREE = 3;
  }
  #endif //FIX_VALUES_H
